...
const RecordMenu = () => {
  return (
    <div className="app-container flex-col p-2">
      ...
      <div className="rounded-md bg-[#2E2E2E] p-4 flex flex-col gap-4">
        ...
        <div className="flex justify-start">
          <input type="date" value={'2023-01-01'} className="py-1 px-4 w-48 rounded-md" />
        </div>
        <div className="flex items-center gap-2">
        ...
        <div className="flex justify-start">
          <input type="time" value={'00:00'} className="py-1 px-4 w-36 rounded-md" />
          ~
          <input type="time" value={'00:00'} className="py-1 px-4 w-36 rounded-md" />
        </div>
        <div className="flex">
